...
export CORE_PEER_ADDRESS=peer0.supplier.medtrack.com:12051
export CORE_PEER_LOCALMSPID=SupplierMSP
export CORE_PEER_MSPCONFIGPATH=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/supplier.medtrack.com/users/Admin@supplier.medtrack.com/msp
export CORE_PEER_TLS_ROOTCERT_FILE=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/peerOrganizations/supplier.medtrack.com/peers/peer0.supplier.medtrack.com/tls/ca.crt
...
echo "✅ Chaincode approved by Supplier"
